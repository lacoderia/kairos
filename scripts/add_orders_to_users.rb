...
compras_omein = 0
CSV.foreach(File.path("scripts/omein_compras_octubre_2018_02.csv"), { :col_sep => ',' }) do |col|
...
compras_prana = 0
CSV.foreach(File.path("scripts/prana_compras_octubre_2018_02.csv"), { :col_sep => ',' }) do |col|
