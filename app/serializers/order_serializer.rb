class OrderSerializer < ActiveModel::Serializer
  attributes :id, :description, :order_number, :total_item_price, :total_item_volume, :total_price, :shipping_price, :items, :created_at, :company, :openpay_id, :redirect_url, :order_status
#  has_many :items
  belongs_to :order
