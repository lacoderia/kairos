class UsersController < ApiController
  ...
  def summary_by_period_with_downlines
    begin
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:first_name, :last_name, :email, :external_id, :iuvare_id, :sponsor_external_id, :placement_external_id, :active, :phone, :password , :password_confirmation, :transaction_number, :iuvare_id)
    end
